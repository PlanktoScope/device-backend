...
# Configuration SPI
spi = spidev.SpiDev()
spi.open(0, 0) #1 Stepper #0 Pump Ouvre le bus SPI (0) et le périphérique (0)
spi.max_speed_hz = 1000000 # Définit la vitesse SPI à 1 MHz

# Configuration des broches GPIO pour Step, Dir et GPIO5
step_pin = 12  #13 Stepper #12 Pump  Numéro de broche pour le signal Step
dir_pin = 27   #17 Stepper #27 Pump  Numéro de broche pour le signal Dir
gpio5_pin = 23  #5 Stepper #23 Pump  Numéro de broche GPIO5 pour le contrôle du moteur
...
try:
    ...
    move_motor_step("backward", 2000)  # Déplace le moteur de 5 pas vers l'avant
